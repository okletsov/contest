...
public class ContestResults {
    ...
    public List<HashMap<String,Object>> getFirstThreeAnnPlaces(String contestId) {

//        Specify id of a seasonal contest which indicates start of the annual contest
//        (Autumn seasonal contest id of the previous year)
        ...
        String sql = "select -- get first 3 places \n" +
                "\tt13.place\n" +
                "\t, t13.user_id\n" +
                "\t, t13.nickname\n" +
                "from (\n" +
